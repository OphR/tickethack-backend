...
var cartsRouter = require("./routes/cartRoutes") // Ajouter si vous voulez créer un nouveau fichier de route
...
app.use("/models", bookingRouter)
app.use("/models", cartsRouter)
app.use("/models", tripRouter) 
